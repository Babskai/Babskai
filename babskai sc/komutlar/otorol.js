...
exports.run = async (client, message, args) => {
    ...
    if(!args[0]) return message.channel.send("**Doğru Kullanım: `otorol kanal-ayarla - Otorol kanalı ayarlarsınız. | otorol kanal-sıfırla - Otorol kanalı sıfırlarsınız. | otorol rol-ayarla - Otorolde verilecek rolü ayarlarsınız. | otorol rol-sıfırla - Otorol verilecek rolü sıfırlarsınız. `NOT: Otorolü ayarlayacağınız rolü, BabskaiBot rolünü üstüne taşıyınız, yoksa çalışmaz.**")
