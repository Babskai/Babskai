...
module.exports.run = async (bot, message, args) => {
  var embed2 = new Discord.RichEmbed()
    ...
    .setDescription(
      "Bu Komutu Kullanabilmek İçin Benim Yöneticim Olmanız Gerekiyor,Aksi Taktirde Kullanılmaz!"
    )
    .setColor("RED");
  ...
  var embed = new Discord.RichEmbed()
    ...
    .setDescription(
      "Beni yeniden başlatmak için lütfen aşağıdaki emojiye tıklarmısınız."
    )
    .setColor("RANDOM");
