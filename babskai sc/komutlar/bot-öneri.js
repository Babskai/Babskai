...
module.exports.run = async (bot, message, args) => {
  if (talkedRecently.has(message.author.id)) {
    if (message.author.id === "730040314726842439") {
      return message.channel.send(
        message.author + "Bu Komutu 1 Saatte Bir Kullanabilirsin! "
      );
    }
  } else {
  ...
  let channel = bot.channels.get("935967736411078659"); //bug repot kanal id
